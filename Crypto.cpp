...
std::string Crypto::Decrypt(std::string& encryptedMsg, std::string& key) {
	std::string newKey = Extend_key(encryptedMsg, key);
	std::string base64EncodedStr = Decrypt_vigenere(encryptedMsg, newKey);
	std::string base64DecodedStr = base64_decode(base64EncodedStr);
	return base64DecodedStr;
}

int Crypto::Index(char c) {
...
std::string Crypto::Extend_key(std::string& msg, std::string& key) {
	//generating new key
	int msgLen = msg.size();
...
std::string Crypto::Encrypt_vigenere(std::string& msg, std::string& key) {
...
std::string Crypto::Decrypt_vigenere(std::string& encryptedMsg, std::string& newKey) {
	// decryption
